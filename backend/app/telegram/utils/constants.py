...
class PaymentMessages:
    ...
    PAYMENT_SUCCESS = (
        ...
        "💫 Оплачено: {stars} ⭐️\n\n"
        "Теперь бот будет автоматически проверять сообщения на запрещенный контент в этом чате."
    )

    AI_CHECK_DISABLED_NO_SUBSCRIPTION = (
        "❌ AI проверка контента отключена для этого чата.\n\n"
        "💡 Чтобы включить AI проверку, оплатите подписку:\n"
        "• Месячная подписка: проверка каждого сообщения на запрещенный контент\n"
        "• Годовая подписка: экономия по сравнению с месячной\n\n"
    ...
    SUBSCRIPTION_EXPIRED = (
        ...
        "📅 Истекла: {end_date}\n\n"
        "Для продолжения использования оплатите новую подписку:"
    )
